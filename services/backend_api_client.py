...
class BackendAPIClient(ClientBase):
    ...
    async def get_controller_config_pydantic(self, controller_type: str, controller_name: str):
        """Get controller configuration with default values using Pydantic model."""
    ...
    async def deploy_script_with_controllers(self,
        ...
        controller_configs_to_deploy = []
        for controller_config in controller_configs:
            if controller_config.endswith(".yml"):
                controller_configs_to_deploy.append(controller_config)
            else:
                controller_configs_to_deploy.append(controller_config + ".yml")
